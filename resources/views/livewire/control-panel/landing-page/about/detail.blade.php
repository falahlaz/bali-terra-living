                ...
                <form wire:submit="store">
                    ...
                    <div class="grid grid-cols-3 gap-5 mb-5">
                            ...
                            >
                                ...
                                >
                                    ...
                                    @foreach($icon_types as $icon_type)
                                        <option
                                            wire:key="content-type-{{$icon_type->value}}"
                                            value="{{ $icon_type->value }}"
                                            class="text-gray-700 dark:bg-gray-900 dark:text-gray-400"
                                        >
                                            {{ $icon_type->asTitle() }}
                                        </option>
                        ...
                        <div>
                            ...
                            <textarea wire:model="form.icon_content" id="icon_content" rows="5"
                                      class="w-full px-5 py-4 rounded-2xl border-2 border-sage/20 focus:border-sage focus:outline-none transition-colors resize-none"
                                      placeholder="Content Value"></textarea>
                            @error('form.icon_content')
                            <p class="text-red-500 text-sm mt-1 italic">{{$message}}</p>
                            @enderror
                        </div>
