        ...
        <x-card.body>
            ...
            <x-tables.base>
                <x-tables.header>
                    ...
                    <x-tables.cells.header title="Section"/>
                    <x-tables.cells.header title="Content Key"/>
                    <x-tables.cells.header title="Content Type"/>
                ...
                <x-tables.body>
                    @foreach($contents as $content)
                        <tr>
                            ...
                            <x-tables.cells.body>
                                <x-button
                                    :href="route('cp.contents.detail', [$content->id])"
                                    with_icon="true"
                                    variant="primary"
                                    width="12"
                                    height="12"
