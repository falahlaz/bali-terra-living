                        ...
                        <form wire:submit="signIn">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    <x-button
                                        text="Sign In"
                                        additional-class="w-full flex items-center justify-center"
                                    >
                                        <x-button.loading target="signIn"/>
                                    </x-button>
                                </div>
                            </div>
                        </form>
            ...
            <div class="flex items-center justify-center z-1">
                ...
                <div class="flex flex-col items-center max-w-xs">
                    <a href="#" class="block mb-4">
                        <img src="https://assets.baliterraliving.com/bali-terra-logo-transparent.png" alt="Logo"/>
                    </a>
