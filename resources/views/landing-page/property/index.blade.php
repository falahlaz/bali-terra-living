<x-landing-page.layouts.app>
                        ...
                        <div>
                            ...
                            <select id="type"
                                ...
                                @foreach($categories as $category)
                                    <option @selected(Request::get('category_id') == $category->id) value="{{ $category->id }}">{{ $category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select id="location"
                                ...
                                @foreach($locations as $location)
                                    <option @selected(Request::get('location_id') == $location->id) value="{{ $location->id }}">{{ $location->name }}</option>
                                @endforeach
                            </select>
                        </div>
    ...
    {{--                    </div>--}}
                    ...
                    <div class="mt-6 flex justify-end">
                        <a href="{{ route('property.index') }}" class="block px-6 py-3 text-sage hover:text-earth font-medium transition-colors mr-3">Reset Filters</a>
                        <button
                            type="submit"
                            class="block bg-sage text-cream px-6 py-3 rounded-2xl hover:bg-earth transition-colors font-medium text-center"
                        >
                            Search
                        </button>
                    </div>
